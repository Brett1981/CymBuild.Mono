...
public sealed class MigrationBootstrapSourceContractTests
{
    ...
    public void RunCreation_AutomaticallyBootstrapsBeforeUsingMigrationRoutines()
    {
        ...
        Assert.Contains("Authorize(Roles = \"SysAdmin\")", schemaService, StringComparison.Ordinal);
        Assert.Contains("Authorize(Roles = \"SysAdmin\")", metadataService, StringComparison.Ordinal);
