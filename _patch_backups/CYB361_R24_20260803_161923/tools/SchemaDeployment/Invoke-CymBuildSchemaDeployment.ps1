<#
.SYNOPSIS
    CYB-361 R23 manual schema deployment runner.
...
function Get-DedicatedMigrationDescriptor {
    ...
    if ($ObjectType.Equals("Table", [System.StringComparison]::OrdinalIgnoreCase) -and
        ...
        return [pscustomobject]@{
            ...
            Description = "Guarded data-preserving ObjectSecurity nullability, default and UserId foreign-key alignment."
        }
    }
...
function Invoke-CymBuildSchemaDeployment {
    ...
    try {
        ...
        Write-Host "CYB-361 R23 schema deployment runner" -ForegroundColor Cyan
