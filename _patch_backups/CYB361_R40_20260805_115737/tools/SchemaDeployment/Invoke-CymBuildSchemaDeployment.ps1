<#
.SYNOPSIS
    CYB-361 R38 manual schema deployment runner.
...
/*
    ...
    Generated by       : CYB-361 R38 schema deployment runner
    Run Guid           : $RunGuid
...
function Invoke-CymBuildSchemaDeployment {
    ...
    try {
        ...
        Write-Host "CYB-361 R38 schema deployment runner" -ForegroundColor Cyan
