# CYB-361 Manual Schema Deployment Runner (R24)
...
## R24 `ROWGUIDCOL` correction

The `SCore.ObjectSecurity` migration now changes `Guid` nullability using the SQL Server-supported sequence inside one transaction:
