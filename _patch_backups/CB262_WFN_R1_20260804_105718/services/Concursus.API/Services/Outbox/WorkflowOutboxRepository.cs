...
(
    ...
    FROM SCore.IntegrationOutbox o WITH (READCOMMITTEDLOCK, READPAST, UPDLOCK, ROWLOCK)
...
(
    ...
    FROM SCore.WorkflowNotificationQueue q WITH (READCOMMITTEDLOCK, READPAST, UPDLOCK, ROWLOCK)
