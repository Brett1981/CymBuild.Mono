...
PRINT (N'Create procedure [SFin].[SageInboundDiagnostics_ApplyTransactionReferences]')
GO
CREATE PROCEDURE [SFin].[SageInboundDiagnostics_ApplyTransactionReferences]
(
