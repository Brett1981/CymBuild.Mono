    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            BEGIN
                ...
                IF NULLIF(LTRIM(RTRIM(ISNULL(@StagedParentName, N''))), N'') IS NOT NULL
                BEGIN
                    SELECT TOP (1)
            ...
            BEGIN
                ...
                SET @ParentResolutionMessage = CONCAT(
                    ...
                    N'. Select/include the parent OU in this run, or ensure the target has a matching parent OU before applying.'
                );
