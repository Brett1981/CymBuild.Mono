/*
    CYB-396 - Retry Pending Error when Syncing Invoices on Inbound Diagnostics
    Purpose: Prevent the fee-cap drawdown guard in SFin.TransactionDetailsUpsert
             from blocking Sage inbound receipt materialisation.
*/

/****** Object:  StoredProcedure [SFin].[TransactionDetailsUpsert]    Script Date: 17/06/2026 11:30:00 ******/
SET ANSI_NULLS ON
GO
