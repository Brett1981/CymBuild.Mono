...
-- Script date 11/05/2026 15:11:33
...
IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END
INSERT SCore.LanguageLabels(ID, RowStatus, Guid, Name) VALUES (4228, 1, '429d4e63-1073-405c-92da-16fd42883604', N'LatestTransitionLocal')
GO
...
GO
DBCC CHECKIDENT('SCore.LanguageLabels', RESEED, 4228)
GO
...
GO
UPDATE SCore.LanguageLabelTranslations SET Text = N'Jobs Missing Consultant', TextPlural = N'Jobs Missing Consultant' WHERE ID = 1832
UPDATE SCore.LanguageLabelTranslations SET Text = N'Date Time UTC', TextPlural = N'Date Time UTC' WHERE ID = 3273
UPDATE SCore.LanguageLabelTranslations SET Text = N'Status', TextPlural = N'Statuses' WHERE ID = 4019
...
IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END
INSERT SCore.LanguageLabelTranslations(ID, RowStatus, Guid, Text, TextPlural, LanguageLabelID, LanguageID, HelpText) VALUES (4213, 1, '83936064-e999-4e5d-b5e2-cd54eba69f53', N'Latest Transition', N'Latest Transition', 4228, 1, N'')
GO
...
GO
DBCC CHECKIDENT('SCore.LanguageLabelTranslations', RESEED, 4213)
GO
...
GO
UPDATE SUserInterface.GridViewColumnDefinitions SET Width = N'150px' WHERE ID = 62
UPDATE SUserInterface.GridViewColumnDefinitions SET Width = N'150px' WHERE ID = 981
UPDATE SUserInterface.GridViewColumnDefinitions SET IsHidden = 1 WHERE ID = 1519
UPDATE SUserInterface.GridViewColumnDefinitions SET ColumnOrder = 10 WHERE ID = 1687
UPDATE SUserInterface.GridViewColumnDefinitions SET ColumnOrder = 11, IsHidden = 1 WHERE ID = 1692
UPDATE SUserInterface.GridViewColumnDefinitions SET ColumnOrder = 21 WHERE ID = 1694
UPDATE SUserInterface.GridViewColumnDefinitions SET ColumnOrder = 7, Width = N'420px' WHERE ID = 1695
UPDATE SUserInterface.GridViewColumnDefinitions SET ColumnOrder = 22 WHERE ID = 1696
UPDATE SUserInterface.GridViewColumnDefinitions SET Width = N'80px' WHERE ID = 1697
UPDATE SUserInterface.GridViewColumnDefinitions SET ColumnOrder = 3 WHERE ID = 1702
...
GO
DBCC CHECKIDENT('SUserInterface.GridViewColumnDefinitions', RESEED, 1768)
GO
