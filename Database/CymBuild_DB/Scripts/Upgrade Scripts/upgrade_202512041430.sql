...
-- Script date 04/12/2025 14:30:26
...
--
UPDATE SUserInterface.GridViewDefinitions SET ShowOnDashboard = 1 WHERE ID = 7
UPDATE SUserInterface.GridViewDefinitions SET ShowOnDashboard = 1 WHERE ID = 16
UPDATE SUserInterface.GridViewDefinitions SET ShowOnDashboard = 1 WHERE ID = 31
UPDATE SUserInterface.GridViewDefinitions SET ShowOnDashboard = 1 WHERE ID = 85
UPDATE SUserInterface.GridViewDefinitions SET ShowOnDashboard = 1 WHERE ID = 98
UPDATE SUserInterface.GridViewDefinitions SET ShowOnDashboard = 1 WHERE ID = 101
UPDATE SUserInterface.GridViewDefinitions SET ShowOnDashboard = 1 WHERE ID = 102
UPDATE SUserInterface.GridViewDefinitions SET ShowOnDashboard = 1 WHERE ID = 118
UPDATE SUserInterface.GridViewDefinitions SET ShowOnDashboard = 1 WHERE ID = 134
UPDATE SUserInterface.GridViewDefinitions SET DetailPageUri = N'EnquiryDetail' WHERE ID = 139
UPDATE SUserInterface.GridViewDefinitions SET ShowOnDashboard = 1 WHERE ID = 186
UPDATE SUserInterface.GridViewDefinitions SET ShowOnDashboard = 1 WHERE ID = 190
GO
