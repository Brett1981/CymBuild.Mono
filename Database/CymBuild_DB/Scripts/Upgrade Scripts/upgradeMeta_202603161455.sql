...
-- Script date 16/03/2026 14:55:09
...
UPDATE SCore.DataObjectTransition 
SET OldStatusID = 7
WHERE OldStatusID = 71
--
-- Deleting data from table SCore.WorkflowStatus
--
PRINT(N'Deleting data from table SCore.WorkflowStatus')
GO
DELETE SCore.WorkflowStatus WHERE ID = 71
