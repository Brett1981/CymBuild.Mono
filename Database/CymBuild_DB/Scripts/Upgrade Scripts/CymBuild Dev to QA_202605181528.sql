...
-- Script date 18/05/2026 15:28:43
...
GO
UPDATE SCore.EntityProperties SET IsHidden = 0, IsCompulsory = 1 WHERE ID = 2380
GO
...
UPDATE SCore.EntityQueries SET Statement = N'EXEC [SJob].[MilestoneTypesUpsert]  
	@Name = @Name, 
	@Code = @Code, 
	@IsActive = @IsActive, 
	...
	@HasQuotedHours = @HasQuotedHours' WHERE ID = 126
EXEC(N'UPDATE SCore.EntityQueries SET Statement = N''SELECT 
...
GO
DBCC CHECKIDENT('SCore.EntityQueries', RESEED, 395)
GO
...
IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END
INSERT SCore.EntityQueryParameters(ID, RowStatus, Guid, Name, EntityQueryID, EntityDataTypeID, MappedEntityPropertyID, DefaultValue, IsInput, IsOutput, IsReturnColumn) VALUES (1623, 1, '7d4d70f0-1663-4509-aef0-00b37f79c592', N'@Guid', 395, 6, 1668, N'', 1, 0, 0)
...
GO
DBCC CHECKIDENT('SCore.EntityQueryParameters', RESEED, 1629)
GO
...
IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END
INSERT SCore.LanguageLabels(ID, RowStatus, Guid, Name) VALUES (4229, 1, 'b975afc0-260e-46cd-95d5-2381d73faef2', N'[SSop].[tvf_Quotes].[Comment]')
GO
...
GO
DBCC CHECKIDENT('SCore.LanguageLabels', RESEED, 4229)
GO
...
GO
UPDATE SCore.LanguageLabelTranslations SET HelpText = N'Unique identifier to distinguish between multiple invoice schedules sharing the same trigger. If there''s only 1 schedule for a trigger, use a name that indicates the purpose' WHERE ID = 3422
...
IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END
INSERT SCore.LanguageLabelTranslations(ID, RowStatus, Guid, Text, TextPlural, LanguageLabelID, LanguageID, HelpText) VALUES (4214, 1, '531b27af-3971-4e1c-a2c7-121248aebdff', N'Comment', N'Comment', 4229, 1, N'')
GO
...
GO
DBCC CHECKIDENT('SCore.LanguageLabelTranslations', RESEED, 4214)
GO
...
GO
UPDATE SUserInterface.GridViewColumnDefinitions SET ColumnOrder = 6 WHERE ID = 1354
UPDATE SUserInterface.GridViewColumnDefinitions SET ColumnOrder = 8 WHERE ID = 1355
UPDATE SUserInterface.GridViewColumnDefinitions SET ColumnOrder = 11 WHERE ID = 1356
UPDATE SUserInterface.GridViewColumnDefinitions SET ColumnOrder = 7 WHERE ID = 1359
UPDATE SUserInterface.GridViewColumnDefinitions SET ColumnOrder = 9 WHERE ID = 1361
UPDATE SUserInterface.GridViewColumnDefinitions SET ColumnOrder = 10 WHERE ID = 1362
UPDATE SUserInterface.GridViewColumnDefinitions SET IsHidden = 0 WHERE ID = 1435
UPDATE SUserInterface.GridViewColumnDefinitions SET IsHidden = 0 WHERE ID = 1442
...
GO
DBCC CHECKIDENT('SUserInterface.GridViewColumnDefinitions', RESEED, 1769)
GO
...
UPDATE SUserInterface.GridViewDefinitions SET AllowExcelExport = 1, AllowCsvExport = 1 WHERE ID = 213
UPDATE SUserInterface.GridViewDefinitions SET SqlQuery = N'SELECT
 *
FROM
