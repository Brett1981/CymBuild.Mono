...
/****** Object:  StoredProcedure [SSop].[QuoteCreateJobs]    Script Date: 22/04/2026 15:30:52 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            BEGIN
                SELECT TOP (1)
                    @InitialInvoiceProcessingMode = CASE WHEN sfj.TriggerId = -1 THEN 1 ELSE 0 END,
                    @InitialManualInvoicingEnabled = CASE WHEN sfj.TriggerId = -1 THEN 1 ELSE 0 END
                FROM @SchedulesForJob sfj
