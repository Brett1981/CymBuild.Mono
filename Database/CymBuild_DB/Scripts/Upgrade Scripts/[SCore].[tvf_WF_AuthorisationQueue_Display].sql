...
/****** Object:  UserDefinedFunction [SCore].[tvf_WF_AuthorisationQueue_Display]    Script Date: 11/05/2026 14:29:47 ******/
SET ANSI_NULLS ON
GO
...
ALTER   FUNCTION  [SCore].[tvf_WF_AuthorisationQueue_Display]
(
    @UserId INT = NULL
)
RETURNS TABLE
