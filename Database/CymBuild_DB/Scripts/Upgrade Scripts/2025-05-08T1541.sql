...
-- Script date 08/05/2025 15:41:38
...
ALTER TABLE SCore.NonActivityEvents
  DROP CONSTRAINT IF EXISTS FK_NonActivityEvents_AbsenceTypes
GO
...
--
-- Inserting data into table [SCore].[NonActivityTypes]
--
...
ALTER TABLE SCore.NonActivityEvents WITH NOCHECK
  ADD CONSTRAINT FK_NonActivityEvents_AbsenceTypes FOREIGN KEY (AbsenceTypeID) REFERENCES SCore.NonActivityTypes(ID) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
