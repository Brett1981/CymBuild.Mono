...
-- Script date 01/04/2025 11:13:59
...
--
UPDATE SCore.EntityProperties SET DropDownListDefinitionID = 92 WHERE ID = 1192
UPDATE SCore.EntityProperties SET DropDownListDefinitionID = 92 WHERE ID = 1193
...
UPDATE SCore.EntityQueries SET EntityHoBTID = 24 WHERE ID = 107
...
' WHERE ID = 214
UPDATE SCore.EntityQueries SET Name = N'Revise Quote', Statement = N'EXEC [SSop].[QuotesRevise]  @SourceGuid = @Guid, @TargetGuid = ''[[TargetGuid]]''', ObjectName = N'QuotesRevise' WHERE ID = 230
UPDATE SCore.EntityQueries SET Statement = N'SELECT	root_hobt.ID,
		root_hobt.Label,
		root_hobt.Class,
		root_hobt.SortOrder 
...
--
DBCC CHECKIDENT('SCore.EntityQueries', RESEED, 311)
GO
...
IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END
INSERT SCore.EntityQueryParameters(ID, RowStatus, Guid, Name, EntityQueryID, EntityDataTypeID, MappedEntityPropertyID, DefaultValue, IsInput, IsOutput, IsReturnColumn) VALUES (1302, 1, '91485820-aec6-4858-83ea-a3e4715e486c', N'@Guid', 310, 6, 1939, N'', 1, 0, 0)
INSERT SCore.EntityQueryParameters(ID, RowStatus, Guid, Name, EntityQueryID, EntityDataTypeID, MappedEntityPropertyID, DefaultValue, IsInput, IsOutput, IsReturnColumn) VALUES (1303, 1, '714588a3-96bf-4188-baf2-09306aa0401f', N'@Guid', 311, 6, 1660, N'', 1, 0, 0)
INSERT SCore.EntityQueryParameters(ID, RowStatus, Guid, Name, EntityQueryID, EntityDataTypeID, MappedEntityPropertyID, DefaultValue, IsInput, IsOutput, IsReturnColumn) VALUES (1304, 1, 'be2bc335-70bc-4758-8770-655d3c4d48dc', N'@ExclusionsAndLimitations', 85, 5, 1843, N'', 1, 0, 0)
GO
...
--
DBCC CHECKIDENT('SCore.EntityQueryParameters', RESEED, 1304)
GO
...
--
UPDATE SCore.LanguageLabels SET Name = N'Revise Quote' WHERE ID = 2022
GO
...
--
UPDATE SCore.LanguageLabelTranslations SET Text = N'Revise Quote', TextPlural = N'Revise Quote' WHERE ID = 2064
GO
