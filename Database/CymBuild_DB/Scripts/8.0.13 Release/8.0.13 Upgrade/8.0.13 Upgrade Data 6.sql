...
-- Script date 28/03/2025 16:21:59
...
--
UPDATE SCore.EntityProperties SET IsCompulsory = 1 WHERE ID = 1795
...
UPDATE SCore.EntityProperties SET DropDownListDefinitionID = 92 WHERE ID = 1827
UPDATE SCore.EntityProperties SET DropDownListDefinitionID = 42 WHERE ID = 1829
UPDATE SCore.EntityProperties SET DropDownListDefinitionID = 43 WHERE ID = 1834
UPDATE SCore.EntityProperties SET IsCompulsory = 1 WHERE ID = 1860
GO
...
', IsManualStatement = 1 WHERE ID = 273
UPDATE SCore.EntityQueries SET Statement = N'SELECT 
	root_hobt.ID
,	root_hobt.Guid
,	root_hobt.RowStatus
...
--
DBCC CHECKIDENT('SCore.EntityQueries', RESEED, 309)
GO
...
IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END
INSERT SCore.EntityQueryParameters(ID, RowStatus, Guid, Name, EntityQueryID, EntityDataTypeID, MappedEntityPropertyID, DefaultValue, IsInput, IsOutput, IsReturnColumn) VALUES (1298, 1, '86da440b-0e9e-4baa-b626-e532496a20b2', N'@MergeDocumentItemTypeId', 309, 6, 1794, N'', 1, 0, 0)
INSERT SCore.EntityQueryParameters(ID, RowStatus, Guid, Name, EntityQueryID, EntityDataTypeID, MappedEntityPropertyID, DefaultValue, IsInput, IsOutput, IsReturnColumn) VALUES (1299, 1, '09a3d5c5-13b2-4d7c-8dca-1b744dd512bd', N'@EntityTypeId', 309, 6, 1796, N'', 1, 0, 0)
INSERT SCore.EntityQueryParameters(ID, RowStatus, Guid, Name, EntityQueryID, EntityDataTypeID, MappedEntityPropertyID, DefaultValue, IsInput, IsOutput, IsReturnColumn) VALUES (1300, 1, '8ebb1a11-d270-40bb-853b-f662a7423dc9', N'@SubFolderPath', 309, 5, 1797, N'', 1, 0, 0)
INSERT SCore.EntityQueryParameters(ID, RowStatus, Guid, Name, EntityQueryID, EntityDataTypeID, MappedEntityPropertyID, DefaultValue, IsInput, IsOutput, IsReturnColumn) VALUES (1301, 1, 'f36c0a48-d3d5-4660-9d2a-9d87c93dd468', N'@ImageColumns', 309, 2, 1798, N'', 1, 0, 0)
GO
...
--
DBCC CHECKIDENT('SCore.EntityQueryParameters', RESEED, 1301)
GO
