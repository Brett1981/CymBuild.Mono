...
-- Script date 26/03/2025 15:32:12
...
--
UPDATE SCore.EntityProperties SET DropDownListDefinitionID = 94 WHERE ID = 475
...
--
DBCC CHECKIDENT('SCore.EntityProperties', RESEED, 2062)
GO
...
IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END
INSERT SCore.EntityPropertyDependants(ID, RowStatus, Guid, ParentEntityPropertyID, DependantPropertyID) VALUES (44, 1, '7f85631a-9ec1-4161-b538-1a686fb485b4', 470, 475)
GO
...
--
DBCC CHECKIDENT('SCore.EntityPropertyDependants', RESEED, 44)
GO
...
UPDATE SCore.EntityQueries SET Statement = N'SELECT * FROM [SJob].[tvf_Jobs_DataPills] ( @Guid, @AppFormReceived, @ClientAppointmentReceived, @ClientAccountGuid, @AgentAccountGuid, @FinanceAccountGuid, @JobCompleted, @JobCancelled, @JobDormant, @JobStarted, @OrganisationalUnitID) root_hobt' WHERE ID = 38
UPDATE SCore.EntityQueries SET Statement = N'SELECT	root_hobt.ID,
		root_hobt.RowStatus,
		root_hobt.RowVersion,
		root_hobt.Guid,
...
UPDATE SCore.EntityQueries SET Statement = N'EXEC [SSop].[QuotesUpsert]  
	...
	@DescriptionOfWorks = @DescriptionOfWorks' WHERE ID = 85
UPDATE SCore.EntityQueries SET Statement = N'SELECT 
...
UPDATE SCore.EntityQueries SET Statement = N'EXEC SJob.FeeAmendmentsUpsert @JobGuid = @JobGuid,			-- uniqueidentifier
							  ...
							  @Guid = @Guid				-- uniqueidentifier
' WHERE ID = 193
UPDATE SCore.EntityQueries SET Statement = N'SELECT * FROM [SSop].[tvf_EnquiryServicesValidate] ( @QuoteGuid, @Guid, @DeclinedToQuoteDate) root_hobt', IsManualStatement = 1 WHERE ID = 197
...
UPDATE SCore.EntityQueries SET Statement = N'EXEC [SSop].[EnquiryServicesExtUpsert]  
	...
	@QuoteGuid = @QuoteGuid, 
	@Guid = @Guid', IsManualStatement = 0 WHERE ID = 288
...
IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END
INSERT SCore.EntityQueryParameters(ID, RowStatus, Guid, Name, EntityQueryID, EntityDataTypeID, MappedEntityPropertyID, DefaultValue, IsInput, IsOutput, IsReturnColumn) VALUES (1294, 1, 'c3075382-e087-4831-9e0b-02e95616dd73', N'@DateDeclinedToQuoteReason', 288, 5, 2062, N'', 1, 0, 0)
INSERT SCore.EntityQueryParameters(ID, RowStatus, Guid, Name, EntityQueryID, EntityDataTypeID, MappedEntityPropertyID, DefaultValue, IsInput, IsOutput, IsReturnColumn) VALUES (1295, 1, 'cce9ede9-c7ed-42f7-84c1-38c825e64da9', N'@DeclinedToQuoteDate', 197, 12, 2056, N'', 1, 0, 0)
INSERT SCore.EntityQueryParameters(ID, RowStatus, Guid, Name, EntityQueryID, EntityDataTypeID, MappedEntityPropertyID, DefaultValue, IsInput, IsOutput, IsReturnColumn) VALUES (1296, 1, '65cecb37-d6bd-4aab-8741-7c9bb70e9eb5', N'@OrganisationalUnitID', 38, 6, 87, N'', 1, 0, 0)
INSERT SCore.EntityQueryParameters(ID, RowStatus, Guid, Name, EntityQueryID, EntityDataTypeID, MappedEntityPropertyID, DefaultValue, IsInput, IsOutput, IsReturnColumn) VALUES (1297, 1, 'ef3af266-28ca-432a-abb8-038fe4317328', N'@DescriptionOfWorks', 85, 5, 1857, N'', 1, 0, 0)
GO
...
--
DBCC CHECKIDENT('SCore.EntityQueryParameters', RESEED, 1297)
GO
...
--
UPDATE SCore.EntityTypes SET DoNotTrackChanges = 1 WHERE ID = 98
GO
...
--
UPDATE SCore.LanguageLabels SET Name = N'[SFin].[tvf_InvoiceRequests].[JobBillingInstruction]' WHERE ID = 2751
...
--
DBCC CHECKIDENT('SCore.LanguageLabels', RESEED, 2821)
GO
...
--
UPDATE SCore.LanguageLabelTranslations SET Text = N'Job Billing Instruction', TextPlural = N'Job Billing Instruction' WHERE ID = 2790
...
IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END
INSERT SCore.LanguageLabelTranslations(ID, RowStatus, Guid, Text, TextPlural, LanguageLabelID, LanguageID, HelpText) VALUES (2861, 1, '61659eef-33ae-474a-8801-535c05ceb3d4', N'Finance Account Billing Instruction', N'Finance Account Billing Instruction', 2821, 1, N'')
GO
...
--
DBCC CHECKIDENT('SCore.LanguageLabelTranslations', RESEED, 2861)
GO
...
IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END
INSERT SUserInterface.DropDownListDefinitions(ID, RowStatus, Guid, Code, NameColumn, ValueColumn, SqlQuery, DefaultSortColumnName, IsDefaultColumn, DetailPageUrl, IsDetailWindowed, EntityTypeId, InformationPageUrl, GroupColumn, ColourHexColumn) VALUES (94, 1, '7c8670f3-4ec5-40d9-956d-f3d0804063f8', N'PROJECTDIRCONTACT', N'DisplayName', N'ContactGuid', N'SELECT	TOP(10)
		root_hobt .DisplayName,
...
WHERE	(root_hobt.RowStatus NOT IN (0, 254))
	...
	AND	(ac.RowStatus NOT IN (0, 254))
        AND         (a.Guid = ''[[ParentGuid]]'')', N'DisplayName', N'0', N'ContactDetail', 0, 25, N'', N'', N'')
GO
...
--
DBCC CHECKIDENT('SUserInterface.DropDownListDefinitions', RESEED, 94)
GO
...
--
UPDATE SUserInterface.GridViewColumnDefinitions SET Name = N'JobBillingInstruction' WHERE ID = 973
...
IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END
INSERT SUserInterface.GridViewColumnDefinitions(ID, RowStatus, Guid, Name, ColumnOrder, GridViewDefinitionId, IsPrimaryKey, IsHidden, IsFiltered, IsCombo, IsLongitude, IsLatitude, DisplayFormat, Width, LanguageLabelId, TopHeaderCategory, TopHeaderCategoryOrder) VALUES (1022, 1, 'a6aa64b4-fc78-4ad9-aebe-0589be9e9a0b', N'CRMBillingInstruction', 0, 168, 0, 0, 0, 0, 0, 0, N'', N'', 2821, N'', 0)
GO
...
--
DBCC CHECKIDENT('SUserInterface.GridViewColumnDefinitions', RESEED, 1022)
GO
