...
-- Script date 16/04/2025 16:06:13
...
'', IsManualStatement = 1 WHERE ID = 159')
...
--
DBCC CHECKIDENT('SCore.EntityQueries', RESEED, 312)
GO
...
IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END
INSERT SCore.EntityQueryParameters(ID, RowStatus, Guid, Name, EntityQueryID, EntityDataTypeID, MappedEntityPropertyID, DefaultValue, IsInput, IsOutput, IsReturnColumn) VALUES (1305, 1, 'f99d369d-e0c5-4aa0-b27a-4422d72d1c6a', N'@Guid', 312, 6, 274, N'', 1, 0, 0)
GO
...
--
DBCC CHECKIDENT('SCore.EntityQueryParameters', RESEED, 1305)
GO
...
--
UPDATE SUserInterface.GridViewColumnDefinitions SET DisplayFormat = N'D' WHERE ID = 574
