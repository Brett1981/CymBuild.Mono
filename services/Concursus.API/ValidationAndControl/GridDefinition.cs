...
internal class GridDefinition : ValidationAndControlBase
{
    #region Public Constructors

    public GridDefinition(System.Security.Claims.ClaimsPrincipal user) : base(user)
    {
        mainTableSchema = "SUserInterface";
        mainTableName = "GridDefinition";
    }
